...
def signature(secret_id, secret_key, method='GET', path='/', params={}, headers={}, expire=120):
...
def createConsumerGroup(params):
    myobj = {"consumer_group": params['consumer_group'], "timeout": 3600, "order": True}

    sign = signature(secret_id='AKIDQcZGju70DKD1a36BtLFxPHuIRL0nDL9h',
                    secret_key='d191njPvCDTVFkESXNJ5PYQDpCSTfjZ8',
                    method='POST', path='/consumergroup',
                    params={},
                    headers={'Host': 'ap-hongkong.cls.tencentcs.com', 'User-Agent': 'AuthSDK'},
                    expire=300)
    #
    url = 'https://{}.cls.tencentcs.com/consumergroup?topic_id={}'.format(params['region'], params['topic_id'])
...
createConsumerGroup({'topic_id': "86df0f8c-dac5-4171-8f5e-77ce2b58df59", 'consumer_group':'wechat_log_consumer_group' , 'region' : "ap-hongkong"})